...
class DiagonalBottomLeftTopRightAnimator(viewWidth: Float, viewHeight: Float) : AbstractValueAnimator(viewWidth, viewHeight) {
    ...
    override fun draw(canvas: Canvas, paint: Paint) {
        ...
        canvas.drawRect(0f, 0f, viewWidth * 1.5f, y1, paint)
        canvas.rotate(-angle.toFloat())
        canvas.rotate(angle.toFloat())
        canvas.drawRect(0f, 0f, viewWidth * 1.5f, y2, paint)
